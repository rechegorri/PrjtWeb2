...
namespace PrjtWeb2_cadastro_ocorrencia.Controllers
{
    public class AlunoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,RA,Curso,nome,endereco,cidade,telefone")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,RA,Curso,nome,endereco,cidade,telefone")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
